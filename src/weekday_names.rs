...
pub const WEEKDAY_NAME_FULL_EN: [&str; 7] = [
    "Thursday",
    "Friday",
    "Saturday",
    "Sunday",
...
pub const WEEKDAY_NAME_HALF_EN: [&str; 7] = ["Thu", "Fri", "Sat", "Sun", "Mon", "Tue", "Wed"];

pub const WEEKDAY_NAME_HALF_CAP_EN: [&str; 7] = ["THU", "FRI", "SAT", "SUN", "MON", "TUE", "WED"];

pub const WEEKDAY_NAME_FULL_FA: [&str; 7] = [
    "پنج شنبه",
    "جمعه",
    "شنبه",
    "یک شنبه",
...
pub const WEEKDAY_NAME_FULL_AR: [&str; 7] = [
    "الخميس",
    "الجمعه",
    "السبت",
    "الأحد",
...
pub const WEEKDAY_NAME_FULL_CN: [&str; 7] = [
    "星期四",
    "星期五",
    "星期六",
    "星期日",
